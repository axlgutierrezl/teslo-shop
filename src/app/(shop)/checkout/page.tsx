            ...
            <div className="mt-5 mb-2 w-full">
              ...
              <p className="mb-5">
                ...
                <span className="text-xs">
                  Al hacer click en &quotColocar orden&ldquo,aceptas nuestros <a href="#" className="underline">terminos y condiciones</a> y <a href="" className="underline">politica de privacidad</a>
